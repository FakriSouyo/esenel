...
- namaBuket harus NAMA BARU yang kamu ciptakan khusus untuk orang ini: unik, puitis, estetik, dan terasa sastra. WAJIB SATU KATA saja — pendek (maksimal 2 suku kata bila memungkinkan), berkesan, mudah diucapkan, seperti nama katalog kami.
...
- Setiap nama buket harus tercipta khusus untuk orang ini, TIDAK BOLEH SAMA untuk dua nama yang berbeda: kalau dua nama berbeda dimasukkan, nama buketnya juga harus berbeda.
...
Struktur jawaban: keluarkan hanya satu objek JSON, tanpa teks lain di luar JSON, dengan format persis:
{
  ...
  "namaBuket": "SATU KATA, NAMA BARU yang puitis dan unik, TIDAK boleh sama dengan nama katalog atau nama input",
...
Nama buket (namaBuket) harus terasa seperti bagian dari katalog kami lewat NADA-nya (pendek, berkesan, mudah diucapkan) tapi tetap nama ciptaan baru SATU KATA — jangan menyalin nama katalog, jangan memakai nama input.`;
...
Ciptakan namaBuket baru yang puitis dan unik untuk nama ini — WAJIB SATU KATA, boleh bernuansa Old English, Jepang, atau Jawa — TIDAK boleh sama dengan nama katalog di atas dan TIDAK boleh memakai nama input atau bagian kata dari nama input.`;
}
